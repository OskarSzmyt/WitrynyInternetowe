<?php
    $link = mysqli_connect('localhost','root','','przychodnia');
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    ...
    <main>
        ...
        <section>
                ...
                <?php
                    $sql = "SELECT imie, nazwisko, choroby_przewlekle, uczulenia FROM `pacjenci` WHERE id=$_POST[inid]";
                    $result = $link->query($sql);
                    $row = mysqli_fetch_assoc($result);
                    echo <<<DANE
                    <p>Imie i nazwisko: $row[imie] $row[nazwisko]</p>
